...
**小红书风格模仿写作。用户给博主/笔记链接/截图，拉取原笔记分析风格指纹，按指纹写新文章。**

[SkillHub 在线安装](https://skillhub.cn/skills/xhs-style-imitation) · [快速使用](#快速使用) · [核心能力](#核心能力) · [使用边界](#使用边界)
